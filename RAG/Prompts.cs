...
namespace HistoryRag.RAG
{
    public static class Prompts
    {
        ...
        {
            return "请你仔细阅读相关内容，结合历史资料进行回答,每一条史资料使用'出处：《书名》原文内容'的形式标注 (如果回答请清晰无误地引用原文,先给出回答，再贴上对应的原文，使用《书名》[]对原文进行标识),，如果发现资料无法得到答案，就回答不知道 \n" +
                   "搜索的相关历史资料如下所示.\n" +
                   "---------------------\n" +
                   $"{contextStr}\n" +
                   "---------------------\n" +
        ...
        {
            return "你是一个历史知识回答修正机器人，你严格按以下方式工作\n" +
